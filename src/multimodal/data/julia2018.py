...
class Julia2018DataModule(pl.LightningDataModule):
    ...
    def __init__(self,
                 ...
                 dataset_path=Path('data/julia2018/time_series.h5'),
        ...
        self.timeseries_dataset_path = Path(f'data/Julia2018/timeseries_{atlas}.nc5')
    ...
    def prepare_data(self):
        ...
        self.get_timeseries(self.timeseries_dataset_path)

    def get_timeseries(self, dataset_path, n_subjects=None):
        import xarray as xr
        with xr.open_dataset(dataset_path, engine='h5netcdf') as ds:
            ds.load()
            self.feature_names_ = ds.coords['region'].values.tolist()
        return ds
    ...
    def setup(self, stage=None):
        ...
        x_time_regions = self.get_timeseries(self.timeseries_dataset_path)
